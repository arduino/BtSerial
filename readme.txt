...
* It is recommended to disconnect the Bluetooth connection on stop() and pause() and reconnect on resume()
  in order to prevent connection errors

This library was based on SweetBlue, a Bluetooth library for Processing and Arduino,
by Andreas Goransson & David Cuartielles at 1scale1.se. For connections between 
...
BtSerial by Andreas Goransson & David Cuartielles & Tom Igoe & Joshua Albers
Version 0.2.0
August 2012
